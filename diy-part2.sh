...
wget -P ./target/linux/ipq40xx/patches-5.10/ https://raw.githubusercontent.com/usakicha/lede/master/target/linux/ipq40xx/patches-5.4/999-ipq40xx-unlock-cpu-frequency.patch
